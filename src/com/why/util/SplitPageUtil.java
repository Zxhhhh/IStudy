...
public class SplitPageUtil {
	...
	public int pageSize=8; // 每页显示的记录条数
	...
	public SplitPageUtil(int totalRows, int currentPage) {
		super();
	...
	public SplitPageUtil(int totalRows, int pageSize, int currentPage) {
	...
	public static void main(String[] args) {
		System.out.println(new SplitPageUtil(20,3,4));//20条记录，每页3条，第4页
	}

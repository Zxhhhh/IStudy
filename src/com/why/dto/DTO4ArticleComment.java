...
public class DTO4ArticleComment {
	...
	public DTO4ArticleComment() {
		super();
	}

	public DTO4ArticleComment(int comment_id, int comment_articleid,
	...
	public DTO4ArticleComment(int comment_articleid,
			String comment_username, String comment_content, String comment_date) {
		super();

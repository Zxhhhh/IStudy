	...
	<jsp:include page="sidebar.jsp"></jsp:include>
		...
		<div class="col-md-6 column" >
			...
			<div class="media" style="margin-bottom: 10px;">
						 <a href="#" class="pull-left"><img src="liveimages/liver4.png" class="img-circle" alt='' /></a>
						...
						<div style="margin-top: 1%;">
						 ...
						 %>
							...
							<span><a onclick="add()"  style="margin-right:10px;text-decoration:none;">向主播提问</a></span>
							<span><a href="" style="float: right;text-decoration:none;">+&nbsp;关注主播</a></span>
							</div>
						</div>
					</div>
   ...
   <ul class="list-unstyled">
    ...
    <div class="media" style="margin-bottom: 15px;">
				...
				<h4 class="media-heading" style="margin-top: 5px;">
						<a  href="live_question_single.jsp" style="color:black;text-decoration:none;">请问这个问题怎么解决?</a>
    ...
    <li>
    <div class="media"  style="margin-bottom: 15px;">
				 <a  class="pull-left"><img src="liveimages/liver4.png" class="img-circle" alt='' /></a>
				<div class="media-body" >
				<div>
				
				<h4 class="media-heading" style="margin-top: 5px;">
						<a href="live_question_single.jsp" style="color:black;text-decoration:none;">不是只是增加填充吗为什么外边框也变大了?</a>
				<font style="float:right;font-size: 15px;color: #42c02e;">主播已回答</font>
					</h4>
    ...
    <div class="media" style="margin-bottom: 15px;">
				...
				<h4 class="media-heading" style="margin-top: 5px;">
						<a href="live_question_single.jsp" style="color:black;text-decoration:none;">怎么给content设置背景颜色啊?</a>
				<font style="float:right;font-size: 15px;color: #42c02e;">主播已回答</font>
					</h4>
    ...
    <ul class="pagination">
		...
		<div class="col-md-4 column" style="padding-left: 3%;">
			...
			<ul class="list-unstyled" style="text-align: left;">
				<li style="margin-top:10px">
						<img alt="140x140" src="liveimages/liver1.png" class="img-circle" />
							...
							<a style="float:right;font-size: 12px;color: #42c02e;margin-top: 5px">+关注</a>
				</li>
				<li style="margin-top:10px">
						<img alt="140x140" src="liveimages/live2.png" class="img-circle" />
							<span style="margin-top: 5px;position: absolute;">
								<span style="color: #333;position:relative">
									<span>
										<a style="text-decoration:none;color:black" href="#"><strong>朱显浩</strong></a>
									</span>
									<br>
									<span style="margin-top:15px;color:#969696">JAVA主播 · 15K关注</span> 
								</span>
				...
				<li style="margin-top:10px">
						<img alt="140x140" src="liveimages/liver4.png" class="img-circle" />
							<span style="margin-top: 5px;position: absolute;">
								<span style="color: #333;position:relative">
									<span>
										<a style="text-decoration:none;color:black" href="#"><strong>毕向东</strong></a>
									</span>
									<br>
									<span style="margin-top:15px;color:#969696">JAVA主播 · 15K关注</span> 
								</span>
				...
				<li style="margin-top:10px">
						<img alt="140x140" src="liveimages/liver5.png" class="img-circle" />
							<span style="margin-top: 5px;position: absolute;">
								<span style="color: #333;position:relative">
									<span>
										<a style="text-decoration:none;color:black" href="#"><strong>张孝祥</strong></a>
									</span>
									<br>
									<span style="margin-top:15px;color:#969696">JAVA主播 · 15K关注</span> 
								</span>
			...
			<a class="btn btn-default btn-sm">查看全部</a>
			</div>
			</div>
		</div>
	</div>

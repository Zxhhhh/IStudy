					...
					<div>
							...
							<div class="bd">
								<ul>
									...
									<li id="all" class="course-nav-item on"><a
										href="study_viewtype_videoBycount.jsp?type_id=<%=type_id%>">全部</a>
									</li>
									<%
									...
									<li id="level" class="course-nav-item"><a
										href="study_viewtype_videoBycount.jsp?type_id=<%=type_id%>&level=<%=vo4Level.getLevel_id()%>"><%=vo4Level.getLevel_name()%></a>
									</li>
							...
							<div class="bd">
								<ul>
									<li class="course-nav-item on"><a
										href="study_viewtype_videoBycount.jsp?type_id=<%=type_id%>">视频</a>
									</li>
									<li class="course-nav-item "><a
										href="study_viewtype_articleBycount.jsp?type_id=<%=type_id%>">文章</a>
									</li>
						...
						<div class="course-tool-bar clearfix">
							<div class="tool-left l">
								<a class="sort-item"
									href="study_viewtype_videoBytime.jsp?type_id=<%=type_id%>">最新</a>
								<a class="sort-item active"
									href="study_viewtype_videoBycount.jsp?type_id=<%=type_id%>">最热</a>
						...
						<div class="course-list salary-raise program-medias">
							<ul class="clearfix">
								...
								<%
									...
									if (level == null) {
										list = new Study_videoService().findAllVideoByCount(type_id);
									} else {
										int video_level = Integer.parseInt(level);
										list = new Study_videoService().findVideoByLevelCount(
												video_level, type_id);
									}
									for (VO4Video vo4Video : list) {
								%>

								<li class="course-one"><a title="<%=vo4Video.getVideo_summary()%>"
									href="video_single.jsp?video_id=<%=vo4Video.getVideo_id()%>" target="_blank">
										<div class="course-list-img">
											<img width="240" height="180" alt="<%=vo4Video.getVideo_summary()%>"
												src="<%=vo4Video.getVideo_pic()%>">
										</div>
										<h5>
											<span><%=vo4Video.getVideo_name()%></span>
										</h5>
										<div class="tags">
											<span><%=vo4Video.getVideo_summary()%></span>
										</div>
										<div class="tips">
											<span class="l"><%=vo4Video.getVideo_time()%></span> <span
												class="l ml20"><%=vo4Video.getVideo_count()%>在学习</span>
										</div> </a></li>

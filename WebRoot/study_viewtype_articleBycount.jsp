							...
							<div class="bd">
								<ul>
									...
									<li id="all" class="course-nav-item on"><a
										href="study_viewtype_articleBycount.jsp?type_id=<%=type_id%>" >全部</a>
									</li>
																		<%
									...
									<li id="level" class="course-nav-item"><a
										href="study_viewtype_articleBycount.jsp?type_id=<%=type_id%>&level=<%=vo4Level.getLevel_id()%>"><%=vo4Level.getLevel_name()%></a>
									</li>
						...
						<div class="course-list salary-raise program-medias">
							<ul class="clearfix">
								...
								<%
									...
									if (level == null) {
										list = new Study_articleService().findAllArticleByCount(type_id);
									} else {
										int article_level = Integer.parseInt(level);
										list = new Study_articleService().findArticleByLevelCount(

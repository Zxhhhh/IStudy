					...
					<div>
							...
							<div class="bd">
								<ul>
									...
									<li id="all" class="course-nav-item on"><a
										href="study_viewtype_videoBytime.jsp?type_id=<%=type_id%>" >全部</a>
									</li>
																		<%
									...
									<li id="level" class="course-nav-item"><a
										href="study_viewtype_videoBytime.jsp?type_id=<%=type_id%>&level=<%=vo4Level.getLevel_id()%>"><%=vo4Level.getLevel_name()%></a>
									</li>
						...
						<div class="course-tool-bar clearfix">
							<div class="tool-left l">
								...
								<a class="sort-item" href="study_viewtype_videoBycount.jsp?type_id=<%=type_id%>">最热</a>
						...
						<div class="course-list salary-raise program-medias">
							<ul class="clearfix">
								...
								<%
									...
									if (level == null) {
										list = new Study_videoService().findAllVideoByTime(type_id);
									} else {
										int video_level = Integer.parseInt(level);
										list = new Study_videoService().findVideoByLevelTime(
												video_level, type_id);
									}
